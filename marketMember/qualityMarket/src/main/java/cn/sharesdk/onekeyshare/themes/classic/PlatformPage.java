...
public abstract class PlatformPage extends OnekeySharePage {
	...
	public void onCreate() {
		...
		llPanel.setBackgroundColor(0xfffffff);
		...
		// cancel button
		LinearLayout.LayoutParams lp22 = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,R.dipToPx(getContext(), 45));
		int dp_20 = R.dipToPx(getContext(), 20);
		int dp_30 = R.dipToPx(getContext(), 30);
		lp22.setMargins(dp_30, dp_20, dp_20, dp_20);
		Button btnCancel = new Button(getContext());
		btnCancel.setText("取消");
		btnCancel.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 20);
		btnCancel.setTextColor(0xffffffff);
		btnCancel.setBackgroundResource(com.jfbank.qualitymarket.R.drawable.button_selector);
        ...
        lp = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,R.dipToPx(getContext(), 95));
        lp.setMargins(0,0,0,0);
        LinearLayout buttonLayout2 = new LinearLayout(activity);
        buttonLayout2.setBackgroundColor(Color.WHITE);
		buttonLayout2.addView(btnCancel, lp22);
