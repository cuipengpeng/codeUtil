...
public class WheelView extends View {
    ...
    private void initPaints() {
        ...
        centerTextBg = new Paint();
        centerTextBg.setColor(Color.parseColor("#f5f5f5"));
        centerTextBg.setAntiAlias(true);
    ...
    public void setNotSelectedTextSize(int notSelectedTextSize) {
        textSize = (int) (context.getResources().getDisplayMetrics().density * notSelectedTextSize);
        paintOuterText.setTextSize(textSize);
    }

    public void setSelectedTextSize(int selectedTextSize) {
        textSize = (int) (context.getResources().getDisplayMetrics().density * selectedTextSize);
        paintCenterText.setTextSize(textSize);
        paintCenterText.setFakeBoldText(true);      //默认加粗
        paintCenterText.setColor(Color.parseColor("#393b51"));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(0, firstLineY, measuredWidth, secondLineY, centerTextBg); //选中条目背景加深
...
//                    canvas.drawRect(0, -CENTERCONTENTOFFSET, measuredWidth, itemHeight, centerTextBg); //选中条目背景加深
                    canvas.drawText(contentText, drawCenterContentStart, maxTextHeight - CENTERCONTENTOFFSET, paintCenterText);
