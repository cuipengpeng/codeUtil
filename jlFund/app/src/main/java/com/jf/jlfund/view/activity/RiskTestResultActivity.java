...
import com.jf.jlfund.adapter.RiskTestResultAdapter;
...
import com.jf.jlfund.weight.holder.RiskEvaluationResultHolder;
...
public class RiskTestResultActivity extends BaseLocalDataActivity {
    ...
    private void getFundCompanyInfo() {
        ...
        HttpRequest.post(HttpRequest.JL_FUND_TEST_ENV_WEB_URL + HttpRequest.RISK_TEST_QUESTIONS, params, this, new HttpRequest.HttpResponseCallBank() {
            @Override
...
//        }
        ...
        HttpRequest.post(HttpRequest.JL_FUND_TEST_ENV_WEB_URL + HttpRequest.SUBMIT_RISK_TEST_ANSWERS, params, this, new HttpRequest.HttpResponseCallBank() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
