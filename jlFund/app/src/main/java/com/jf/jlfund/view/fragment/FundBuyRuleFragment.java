...
import com.jf.jlfund.adapter.TradeNoticePreferredAdapter;
import com.jf.jlfund.adapter.TradeNoticeRansomAdapter;
import com.jf.jlfund.base.BaseUIFragment;
import com.jf.jlfund.bean.FundArchivesWithAnnouncementBean;
import com.jf.jlfund.bean.TradeNoticeBean;
import com.jf.jlfund.http.HttpRequest;
import com.jf.jlfund.utils.StringUtil;
import com.jf.jlfund.view.activity.TradeNoticeActivity;
...
//        withdrawstate	int	赎回状态   1开放  2暂停
    ...
    private void getFundCompanyInfo() {
        ...
        HttpRequest.post(HttpRequest.JL_FUND_TEST_ENV_WEB_URL+HttpRequest.TRADE_NOTICE, params, this, new HttpRequest.HttpResponseCallBank() {
            @Override
