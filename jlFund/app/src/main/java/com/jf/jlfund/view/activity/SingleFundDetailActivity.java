...
import com.jf.jlfund.adapter.FundAnnouncementListShortAdapter;
import com.jf.jlfund.adapter.SingleFundPagerAdapter;
import com.jf.jlfund.base.BaseUIActivity;
import com.jf.jlfund.bean.FundArchivesWithAnnouncementBean;
import com.jf.jlfund.bean.FundTrendBean;
import com.jf.jlfund.bean.SingleFundDetailBean;
...
//                dialog.setContentView(view);
    ...
    private void getFundDetailInfo() {
        ...
        HttpRequest.post(HttpRequest.JL_FUND_TEST_ENV_WEB_URL + HttpRequest.SINGLE_FUND_DETAIL, params, this, new HttpRequest.HttpResponseCallBank() {
            @Override
...
//                    fundTypeTag2TextView.setBackgroundResource(R.drawable.rectangle_gray_border_gray_bg);
    ...
    private void getFundArchivesWithAnnouncement() {
        ...
        HttpRequest.post(HttpRequest.JL_FUND_TEST_ENV_WEB_URL + HttpRequest.FUND_ARCHIVES_WITH_ANNOUNCEMENT, params, this, new HttpRequest.HttpResponseCallBank() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
    ...
    private void getSingleFundYieldTrend() {
        ...
        HttpRequest.post(HttpRequest.JL_FUND_TEST_ENV_WEB_URL + HttpRequest.SINGLE_FUND_YIELD_TREND, params, this, new HttpRequest.HttpResponseCallBank() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
...
//        params.put("fundcode", fundCode);
        ...
        HttpRequest.post(HttpRequest.JL_FUND_TEST_ENV_WEB_URL + HttpRequest.ADD_TO_OPTIONAL_FUND, params, this, new HttpRequest.HttpResponseCallBank() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
                baseRightMenuImageView.setBackgroundResource(R.mipmap.optional_selected);
