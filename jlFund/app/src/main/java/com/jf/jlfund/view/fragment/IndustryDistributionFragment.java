...
import com.jf.jlfund.adapter.IndustryDistributionAdapter;
...
public class IndustryDistributionFragment extends BaseUIFragment {
    ...
    private void getFundCompanyInfo(){
        ...
        HttpRequest.post(HttpRequest.JL_FUND_TEST_ENV_WEB_URL+HttpRequest.INDUSTRY_DISTRIBUTION, params, this,  new HttpRequest.HttpResponseCallBank() {
            @Override
