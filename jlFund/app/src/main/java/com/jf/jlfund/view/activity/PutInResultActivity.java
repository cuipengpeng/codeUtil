...
import com.jf.jlfund.bean.BaobaoTradeRecordDetailBean;
...
//    }
    ...
    private void getBaobaoBuyRecordDetail() {
        ...
        HttpRequest.post(HttpRequest.JL_FUND_TEST_ENV_WEB_URL + HttpRequest.BAOBAO_BUY_RECORD_DETAIL, params, this, new HttpRequest.HttpResponseCallBank() {
            @Override
