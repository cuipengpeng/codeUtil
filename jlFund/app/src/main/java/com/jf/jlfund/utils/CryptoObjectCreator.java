...
public class CryptoObjectCreator {
            ...
            public void run() {
                try {
                    if (mCryptoObject != null) {
                        ...
                        // of the fingerprint.
                        if (!initCipher()) {
                            LogUtils.d("Failed to init Cipher.");
                        }
                    }
                } catch (Exception e) {
                    LogUtils.d(" Failed to init Cipher, e:" + Log.getStackTraceString(e));
                }
    ...
    private void createKey() {
        ...
        try {
            ...
            LogUtils.d("Failed to createKey, e:" + Log.getStackTraceString(e));
    ...
    private boolean initCipher() {
        try {
            ...
            LogUtils.d(" Failed to initCipher, e:" + Log.getStackTraceString(e));
            return false;
