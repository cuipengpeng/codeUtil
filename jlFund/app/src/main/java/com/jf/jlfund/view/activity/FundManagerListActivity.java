...
import com.jf.jlfund.adapter.FundManagerListAdapter;
import com.jf.jlfund.base.BaseUIActivity;
import com.jf.jlfund.bean.FundManagerDetailBean;
...
public class FundManagerListActivity extends BaseUIActivity {
    ...
    private void getFundCompanyInfo() {
        ...
        HttpRequest.post(HttpRequest.JL_FUND_TEST_ENV_WEB_URL+HttpRequest.FUND_MANAGER_DETAIL, params, this, new HttpRequest.HttpResponseCallBank() {
            @Override
