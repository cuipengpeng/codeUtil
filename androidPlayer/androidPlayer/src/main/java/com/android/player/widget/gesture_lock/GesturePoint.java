...
public class GesturePoint {
    ...
    public void setPointState(int state) {
        pointState = state;
        switch (state) {
            case GestureDrawline.POINT_STATE_NORMAL:
                this.image.setBackgroundResource(R.drawable.gesture_node_normal_new);
                break;
            case GestureDrawline.POINT_STATE_WRONG:
                this.image.setBackgroundResource(R.drawable.gesture_node_selected);
                break;
            case GestureDrawline.POINT_STATE_SELECTED:
            case GestureDrawline.POINT_STATE_CORRECT:
                this.image.setBackgroundResource(R.drawable.gesture_node_correct);
                break;
            default:
                break;
        }
