...
public class DataBaseProvider extends ContentProvider {
	...
	static {
		URI_MATCHER.addURI(Constants.AUTHORITY, Constants.PLAYLIST_PATH,

		PLAYLIST);

		URI_MATCHER.addURI(Constants.AUTHORITY, Constants.AUDIO_LIST_PATH,
