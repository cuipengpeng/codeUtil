...
-keep class com.caishi.chaoge.bean.** { *; }
#
# ----------------------------- 其他的 -----------------------------
#
# 删除代码中Log相关的代码
...
-keep class com.caishi.chaoge.ui.widget.**{*;}
-dontwarn com.caishi.chaoge.ui.widget.**

-keep class android.arch.core.**{*;}
-keep class android.arch.lifecycle.**{*;}
-keep class com.transitionseverywhere.**{*;}
-keep class android.util.**{*;}
-keep class cafe.adriel.androidaudioconverter.**{*;}
...
-keep class com.caishi.chaoge.bean.**{*;}#这是你定义的实体类
...
#NiceImageView
-keep class com.othershe.library.** {*;}
...
-keep class com.shuyu.gsyvideoplayer.armv7a.** { *; }
...
-keep class com.umeng.socialize.sina.SinaAPI.** {*;}
...
-keep class com.example.jokecaptionlib.**  {*;}
