...
public class CrashAppLog implements UncaughtExceptionHandler {
     ...
     * 异常日志文件文件夹
     */
    private final String CRASHLOGPATH = "" + Environment.getExternalStorageDirectory() + File.separator + "ChaoGe/crashLog/";
    /**
     * 日期格式
     */
...
//			Log.e(TAG, ""+buffer.toString());
    ...
    private void writeFileToSdcard(String fileName, String buffer) {
        ...
        try {
            ...
            if (!flod.exists()) {
                boolean mkdirs = flod.mkdirs();
                LogUtil.d("创建===" + CRASHLOGPATH + "===" + mkdirs);
            }
