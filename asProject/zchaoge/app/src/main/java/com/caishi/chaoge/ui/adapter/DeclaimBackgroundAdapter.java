...
public class DeclaimBackgroundAdapter extends BaseQuickAdapter<BackgroundBean, BaseViewHolder> {
    public DeclaimBackgroundAdapter() {
        super(R.layout.item_declaim_background);
    }
