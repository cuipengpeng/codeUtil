...
public class MD5Util {
    ...
    public static String md5(String data) {
        ...
        try {
            ...
            MessageDigest mdInst = MessageDigest.getInstance("md5");//MD5Util ，SHA-1,SHA-256，SHA-384，SHA-512
            // 使用指定的字节更新摘要
    ...
    public static String messageDigest(String str, String type){
    ...
    public static String Encrypt(String strSrc, String encName) {
        ...
        try {
            ...
            md = MessageDigest.getInstance(encName);//MD5Util ，SHA-1,SHA-256，SHA-384，SHA-512
            md.update(bt);
