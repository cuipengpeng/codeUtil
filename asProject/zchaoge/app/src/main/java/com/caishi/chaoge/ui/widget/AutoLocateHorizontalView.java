...
public class AutoLocateHorizontalView extends RecyclerView {
    ...
    private boolean isSmoothScrollBy = true;
    ...
    private List<PagerItemBean> pagerItemBeans;
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                if (isInit) {
                    ...
                    linearLayoutManager.scrollToPositionWithOffset(0, -initPos * (wrapAdapter.getItemWidth()) - 220);
                    isInit = false;
                }
            }
        });
    ...
    public void setData(List<PagerItemBean> pagerItemBeans) {
        this.pagerItemBeans = pagerItemBeans;
    }
...
//        }
    ...
    public void onScrollStateChanged(int state) {
        ...
        if (state == SCROLL_STATE_IDLE) {
            ...
            LogUtil.d(overLastPosOffset + "====overLastPosOffset");
            if (overLastPosOffset == 0) {
                ...
                isSmoothScrollBy = true;
                smoothScrollBy((itemWidth - overLastPosOffset), 0);
            } else {
                smoothScrollBy(-(itemWidth + overLastPosOffset - 220), 0);
            }
            calculateSelectedPos();
...
//            }
            ...
            if (listener != null && oldSelectedPos != selectPos && !isSmoothScrollBy) {
                for (int i = 0; i < pagerItemBeans.size(); i++) {
                    pagerItemBeans.get(i).isSelect = i == selectPos;
                }
                ((MainTabAdapter) adapter).setData(pagerItemBeans);
                listener.selectedPositionChanged(selectPos);
            }
