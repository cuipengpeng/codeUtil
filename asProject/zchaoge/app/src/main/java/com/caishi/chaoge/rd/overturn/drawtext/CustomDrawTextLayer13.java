...
/**
 */
public class CustomDrawTextLayer13 extends CustomDrawTextLayer {
    public CustomDrawTextLayer13(TextLayer layer) {
        super(layer);
    }
    ...
    public void init14Show(float timelineFrom, float timelineTo) {
        ...
        showVerticalTextLayerShow(timelineFrom, timelineTo,randomNumList.get(showPosition));
    }
