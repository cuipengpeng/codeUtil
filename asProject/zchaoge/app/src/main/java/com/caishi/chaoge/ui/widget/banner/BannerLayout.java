package com.caishi.chaoge.ui.widget.banner;
...
import com.caishi.chaoge.ui.widget.banner.layoutmanager.BannerLayoutManager;
import com.caishi.chaoge.ui.widget.banner.layoutmanager.CenterSnapHelper;
...
public class BannerLayout extends FrameLayout {
    ...
    private OnBannerItemScrollListener onBannerItemScrollListener;
    int itemSpace;
    float centerScale;
    float moveSpeed;
...
//        app:moveSpeed	setMoveSpeed(float moveSpeed)	滚动速度，越大越快	float	1.0
    ...
    public void setScrollToPosition(int currentIndex) {
    ...
    public void setAdapter(RecyclerView.Adapter adapter) {
        ...
        mLayoutManager.setInfinite(false);
        setPlaying(true);
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (null != onBannerItemScrollListener)
                    onBannerItemScrollListener.onScroll(currentIndex);
    ...
    public void setOnBannerItemScrollListener(OnBannerItemScrollListener onBannerItemScrollListener) {
        this.onBannerItemScrollListener = onBannerItemScrollListener;
