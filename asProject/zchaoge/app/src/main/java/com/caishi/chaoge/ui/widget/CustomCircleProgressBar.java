...
public class CustomCircleProgressBar extends View {
    ...
    public CustomCircleProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        outsideRadius = a.getDimension(R.styleable.CustomCircleProgressBar_outside_radius, Utils.dp2px(getContext(), 60));
        insideColor = a.getColor(R.styleable.CustomCircleProgressBar_inside_color, ContextCompat.getColor(getContext(), R.color.colorWhite));
        ...
        progressTextSize = a.getDimension(R.styleable.CustomCircleProgressBar_progress_text_size, Utils.dp2px(getContext(), 14));
        progressWidth = a.getDimension(R.styleable.CustomCircleProgressBar_progress_width, Utils.dp2px(getContext(), 10));
        ...
        direction = a.getInt(R.styleable.CustomCircleProgressBar_direction, 1);
        a.recycle();
        paint = new Paint();
    }
