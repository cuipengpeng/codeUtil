...
public class ModelScenarioFragment extends BaseUILocalDataFragment {
    ...
    int op = 0;
    String mModelId = "1";//区分具体的剧本分类
    public static final String KEY_OF_SCENARIO_CONTENT = "scenarioData";

    public static ModelScenarioFragment newInstance(String modelId) {
        ModelScenarioFragment fragment = new ModelScenarioFragment();
        fragment.mModelId = modelId;
        return fragment;
    }
    ...
    public void getData(long since, String slipType) {
        ...
        paramsMap.put("modelId", mModelId);

        HttpRequest.post(true, HttpRequest.APP_INTERFACE_WEB_URL + RequestURL.GET_MODEL_SCRIPT, paramsMap, new HttpRequest.HttpResponseCallBank() {
            @Override
