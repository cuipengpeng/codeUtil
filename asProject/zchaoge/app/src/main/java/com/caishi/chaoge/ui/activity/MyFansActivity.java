...
import com.caishi.chaoge.ui.adapter.MyFansAdapter;
...
public class MyFansActivity extends BaseUILocalDataActivity{
    ...
    protected void onNewIntent(Intent intent) {
        ...
        userId = intent.getStringExtra(MyFollowsActivity.KEY_OF_USER_ID);
    }

    @Override
    protected void initPageData() {
        userId = getIntent().getStringExtra(MyFollowsActivity.KEY_OF_USER_ID);
        ...
        myFansAdapter = new MyFansAdapter(mContext);
        ...
        rvMyFansActivityAttentionList.setOnLoadMoreListener(new AutoLoadMoreRecyclerView.OnLoadMoreListener() {
            ...
            public void onLoadMore() {
                ...
                getMyFansList(false, targetTime, "UP");
            }
        });
    }
    ...
    private void getMyFansList(final boolean refresh, long startTime, String direction) {
        Map<String, String> paramsMap = new HashMap<String, String>();
        paramsMap.put("userId", userId);
        paramsMap.put("pageSize", MyFollowsActivity.PAGE_SIZE + "");
        paramsMap.put("since", startTime + "");
        paramsMap.put("slipType", direction);

        HttpRequest.post(true, HttpRequest.APP_INTERFACE_WEB_URL + RequestURL.MY_FANS, paramsMap, new HttpRequest.HttpResponseCallBank() {
            @Override
            public void onSuccess(String response) {
                ...
                if (refresh && myFansBeanList.size() <= 0) {
                    ...
                    if (myFansBeanList.size() < MyFollowsActivity.PAGE_SIZE) {
