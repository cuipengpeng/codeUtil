...
/**
 */
public class CustomDrawTextLayer19 extends CustomDrawTextLayer {
    public CustomDrawTextLayer19(TextLayer layer) {
        super(layer);
    }
