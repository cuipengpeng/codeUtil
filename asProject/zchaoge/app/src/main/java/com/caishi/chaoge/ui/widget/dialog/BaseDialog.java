...
import com.caishi.chaoge.ui.widget.dialog.manager.DialogsManager;
        ...
        if (dialog != null) {
            ...
            dialog.setOnKeyListener(new DialogInterface.OnKeyListener() {
                ...
                public boolean onKey(DialogInterface dialog, int keyCode, KeyEvent event) {
                    if (keyCode == KeyEvent.KEYCODE_BACK && null != onBackListener)
                        onBackListener.onBack(isCancelable());
