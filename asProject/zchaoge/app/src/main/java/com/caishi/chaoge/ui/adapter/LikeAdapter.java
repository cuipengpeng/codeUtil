...
import com.caishi.chaoge.bean.LikeBean;
import com.caishi.chaoge.bean.ProductionBean;
...
public class LikeAdapter extends BaseQuickAdapter<HomeDataBean,BaseViewHolder> {
    public LikeAdapter() {
