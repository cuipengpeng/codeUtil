...
/**
 */
public class CustomDrawTextLayer21 extends CustomDrawTextLayer {
    public CustomDrawTextLayer21(TextLayer layer) {
        super(layer);
    }
    ...
    public void init22Show(float timelineFrom, float timelineTo) {
        super.init22Show(timelineFrom, timelineTo);
    ...
    public void init23Anim(float timelineFrom, float timelineTo) {
        super.init23Anim(timelineFrom, timelineTo);
        showTopTranslationOnceTextLayerShow(timelineFrom,timelineTo,randomNumList.get(showPosition));
