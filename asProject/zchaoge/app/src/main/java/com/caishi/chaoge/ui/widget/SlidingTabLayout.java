...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
            ...
            if (tv_tab_title != null) {
                ...
                if (i == mCurrentTab)
                    tv_tab_title.setTextSize(21);
                else
                    tv_tab_title.setTextSize(17);
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            if (tab_title != null) {
                ...
                tab_title.setTextSize(isSelect ? 21 : 17);
...
//                }
    ...
    public void setSelectTextize(float mSelectTextsize) {
        this.mSelectTextsize = sp2px(mSelectTextsize);
        updateTabStyles();
    }
