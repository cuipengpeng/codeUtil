...
//     * @param iv
//     */
//    public static void loadBlurImg(Object obj, ImageView iv) {
//        Drawable placeholder = getDrawable(iv.getContext(), sCommonPlaceholder);
//        Glide.with(iv.getContext()).load(obj).apply(getRequestOptions()
//                // 设置高斯模糊
//                .bitmapTransform(new BlurTransformation( 20, 3))
//                .error(placeholder)
//                .placeholder(placeholder)
//                .fallback(placeholder)
//                .dontAnimate()).into(iv);
