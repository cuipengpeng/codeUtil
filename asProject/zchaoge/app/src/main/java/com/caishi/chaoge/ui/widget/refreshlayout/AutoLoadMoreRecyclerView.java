package com.caishi.chaoge.ui.widget.refreshlayout;
...
public class AutoLoadMoreRecyclerView extends RecyclerView {
    ...
    public void setFooterTextColor(String footerTextColor) {
        ...
        if (mFootViews.get(0) instanceof LoadingMoreFooter) {
            LoadingMoreFooter moreFooter = (LoadingMoreFooter) mFootViews.get(0);
            moreFooter.setTextColor(footerTextColor);
        }
    }
...
//            LogUtil.printLog("lastVisibleItemPosition=" + lastVisibleItemPosition + "--itemCount=" + layoutManager.getItemCount() + "--offsetToLoadMore=" + offsetToLoadMore);
//            LogUtil.printLog("isnomore=" + isnomore + "--isBeforeRefreshing()=" + isBeforeRefreshing()+"--layoutManager.getChildCount()="+layoutManager.getChildCount());
