...
public class TemplateListAdapter extends BaseQuickAdapter<RecommendBean, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder helper, RecommendBean item) {
        ...
        if (item.isSelect) {
            ...
            img_itemTemplate_image.setBorderWidth(2);
        } else {
            img_itemTemplate_image.setBorderWidth(2);
            img_itemTemplate_image.setBorderColor(Color.parseColor("#FFFFFF"));
        }
    }
