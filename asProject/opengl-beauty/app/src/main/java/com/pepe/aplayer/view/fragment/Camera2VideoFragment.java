...
//                        .show(getChildFragmentManager(), FRAGMENT_DIALOG);
    ...
    private void openCamera(int width, int height) {
        ...
        try {
            ...
            mVideoPreviewSize = chooseOptimalSize(map.getOutputSizes(SurfaceTexture.class),
                    width, height, mVideoSize);

            int orientation = getResources().getConfiguration().orientation;
//            if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
//                mTextureView.setAspectRatio(mVideoPreviewSize.getWidth(), mVideoPreviewSize.getHeight());
//            } else {
//                mTextureView.setAspectRatio(mVideoPreviewSize.getHeight(), mVideoPreviewSize.getWidth());
//            }
//            configureTransform(width, height);
...
//        }
        try {
            ...
            mGlsurfaceView.surfaceTexture.setDefaultBufferSize(mVideoPreviewSize.getWidth(), mVideoPreviewSize.getHeight());
            Surface previewSurface = new Surface( mGlsurfaceView.surfaceTexture);
    ...
    private void configureTransform(int viewWidth, int viewHeight) {
        Activity activity = getActivity();
//        if (null == mTextureView || null == mVideoPreviewSize || null == activity) {
//            return;
//        }
        int rotation = activity.getWindowManager().getDefaultDisplay().getRotation();
        Matrix matrix = new Matrix();
        RectF viewRect = new RectF(0, 0, viewWidth, viewHeight);
        RectF bufferRect = new RectF(0, 0, mVideoPreviewSize.getHeight(), mVideoPreviewSize.getWidth());
        ...
        if (Surface.ROTATION_90 == rotation || Surface.ROTATION_270 == rotation) {
            ...
            float scale = Math.max(
                    (float) viewHeight / mVideoPreviewSize.getHeight(),
                    (float) viewWidth / mVideoPreviewSize.getWidth());
...
//            SurfaceTexture texture = mTextureView.getSurfaceTexture();
    ...
    private void closePreviewOrVideoSession() {
