...
public class ForegroundLinearLayout extends LinearLayout {
     ...
     *
     * @return PicassoRoundTransform Drawable or null if no foreground was set.
     */
    ...
    /**
     * Supply CircleTransform Drawable that is to be rendered on top of all of the child
