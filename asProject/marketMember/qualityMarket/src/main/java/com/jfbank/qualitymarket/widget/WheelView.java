...
//            position = divided + offset + 1;
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(Color.parseColor("#ffff4444"));		//改变选中字体颜色0288ce
            } else {
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (null == paint) {
            paint = new Paint();
            paint.setColor(Color.parseColor("#ffbbbbbb"));	//修改线的颜色83cde6
        ...
        background = new Drawable() {
            ...
            public void draw(Canvas canvas) {
               ...
               // canvas.drawLine(viewWidth * 1 / 6, obtainSelectedAreaBorder()[1], viewWidth * 5 / 6, obtainSelectedAreaBorder()[1], paint);
                canvas.drawLine(viewWidth * 1 / viewWidth, obtainSelectedAreaBorder()[0], viewWidth * 5 / 1, obtainSelectedAreaBorder()[0], paint);		//改变线长
                canvas.drawLine(viewWidth * 1 / viewWidth, obtainSelectedAreaBorder()[1], viewWidth * 5 / 1, obtainSelectedAreaBorder()[1], paint);
            }
