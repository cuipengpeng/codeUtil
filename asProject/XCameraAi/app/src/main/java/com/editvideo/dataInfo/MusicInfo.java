...
public class MusicInfo implements Serializable{
    ...
    private boolean m_fade_in;
    private boolean m_fade_out;
    ...
    public MusicInfo clone() {
        ...
        musicInfo.setM_fade_in(this.isM_fade_in());
        musicInfo.setM_fade_out(this.isM_fade_out());
        musicInfo.setLrcPath(this.getLrcPath());
        return musicInfo;
    }

    public boolean isM_fade_in() {
        return m_fade_in;
    }

    public void setM_fade_in(boolean m_fade_in) {
        this.m_fade_in = m_fade_in;
    }

    public boolean isM_fade_out() {
        return m_fade_out;
    }

    public void setM_fade_out(boolean m_fade_out) {
        this.m_fade_out = m_fade_out;
    }
