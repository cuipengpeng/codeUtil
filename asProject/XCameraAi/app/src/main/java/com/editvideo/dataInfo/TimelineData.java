...
import static com.editvideo.Constants.VIDEOVOLUME_MUSIC_DEFAULTVALUE;
...
public class TimelineData {
    ...
    /*字幕*/
    private ArrayList<CaptionInfo> m_captionArray;//字幕信息
    /*组合字幕*/
    ...
    /*音乐音量*/
    private float m_musicVolume = VIDEOVOLUME_MUSIC_DEFAULTVALUE;
    /*视频音量*/
     ...
     * 视频宽高
     */
    private int mVideoCanvasWidth;
    private int mVideoCanvasHeight;

    public int getVideoCanvasWidth() {
        return mVideoCanvasWidth;
    }

    public void setVideoCanvasWidth(int mVideoCanvasWidth) {
        this.mVideoCanvasWidth = mVideoCanvasWidth;
    }

    public int getVideoCanvasHeight() {
        return mVideoCanvasHeight;
    }

    public void setVideoCanvasHeight(int mVideoCanvasHeight) {
        this.mVideoCanvasHeight = mVideoCanvasHeight;
    }
