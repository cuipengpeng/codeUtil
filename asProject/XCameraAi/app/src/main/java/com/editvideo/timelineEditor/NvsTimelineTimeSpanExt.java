package com.editvideo.timelineEditor;
...
public class NvsTimelineTimeSpanExt extends RelativeLayout {
    ...
    private void init(Context context){
        ...
        mLTopHandle = parentRoot.findViewById(R.id.lTopHandle);
        mLTopHandleHeight = mLTopHandle.getLayoutParams().height;
        mLBottomLayout = parentRoot.findViewById(R.id.lBottomLayout);
        mLLeftLayout = parentRoot.findViewById(R.id.lLeftHandleLayout);
        mLRightLayout = parentRoot.findViewById(R.id.lRightHandleLayout);
        mLLeftHandle = parentRoot.findViewById(R.id.lLeftHandle);
        mLRightHandle = parentRoot.findViewById(R.id.lRightHandle);
        mLeftHandleImage = parentRoot.findViewById(R.id.leftHandleImage);
        mLLeftHandleWidth = mLLeftHandle.getLayoutParams().width;
        mRTopHandle = parentRoot.findViewById(R.id.rTopHandle);
        mRBottomLayout = parentRoot.findViewById(R.id.rBottomLayout);
        mRLeftLayout = parentRoot.findViewById(R.id.rLeftHandleLayout);
        mRRightLayout = parentRoot.findViewById(R.id.rRightHandleLayout);
        mRLeftHandle = parentRoot.findViewById(R.id.rLeftHandle);
        mRRightHandle = parentRoot.findViewById(R.id.rRightHandle);
        mRightHandleImage = parentRoot.findViewById(R.id.rightHandleImage);
    }
