...
public class CommonDialog extends Dialog {
    ...
    private void initView() {
        mTitleTxt = findViewById(R.id.dialog_title);
        mFirstTipsTxt = findViewById(R.id.dialog_first_tip);
        mSecondTipsTxt = findViewById(R.id.dialog_second_tip);
        mOkBtn = findViewById(R.id.ok_btn);
        mCandelBtn = findViewById(R.id.cancel_btn);
        mCancelBtnLayout = findViewById(R.id.cancel_btn_layout);
        mOkBtnLayout = findViewById(R.id.ok_btn_layout);
