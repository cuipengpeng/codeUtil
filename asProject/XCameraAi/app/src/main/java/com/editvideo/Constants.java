...
public class Constants {
    ...
    public static  boolean EDIT_VIDEO_FINISH =false ;
    public static  boolean EDIT_VIDEO_DETAIL_FINISH =false ;
    /**
     * 屏幕点击常量定义
     */
    //点击时长，单位微秒
    ...
    public static final float VIDEOVOLUME_MIN_VALUE_VOLUME = 0f;
    public static final float VIDEOVOLUME_MUSIC_DEFAULTVALUE = 1.0f;
    public static final float VIDEOVOLUME_MUSIC_MAXVOLUMEVALUE = 2.0f;
    public static final int VIDEOVOLUME_MAXSEEKBAR_VALUE = 100;

    public final static float MAX_VALUE_FOR_VIGNETTE = 1f;//暗角
    public final static float MAX_VALUE_FOR_SHARPEN = 5f; //锐度
    public final static float MAX_VALUE_FOR_BRIGHTNESS = 10f;//曝光
    public final static float MAX_VALUE_FOR_CONTRAST = 10f;//对比度
    public final static float MAX_VALUE_FOR_SATURATION = 10f;//饱和度

    public final static float MIN_VALUE_FOR_VIGNETTE = 0f;
    public final static float MIN_VALUE_FOR_SHARPEN = 0f;
    public final static float MIN_VALUE_FOR_BRIGHTNESS = 0f;
    public final static float MIN_VALUE_FOR_CONTRAST = 0f;
    public final static float MIN_VALUE_FOR_SATURATION = 0f;
     ...
     *美颜    磨皮  美白 红润
     */
//    public final static String FX_BEAUTY = "AR Scene";
    public final static String AR_SCENE = "Beauty";

        public final static String FX_BEAUTY_MOPI = "Strength"; //磨皮
        public final static String FX_BEAUTY_RED = "Reddening"; //红润
    public final static String FX_BEAUTY_WHITE = "Whitening"; //美白
//    public final static String FX_BEAUTY_MOPI = "Beauty Strength";  //磨皮
//    public final static String FX_BEAUTY_RED = "Beauty Reddening"; //红润
//    public final static String FX_BEAUTY_WHITE = "Beauty Whitening"; //美白
    public final static String FX_BEAUTY_THIN_FACE = "Face Size Warp Degree"; //瘦脸
    public final static String FX_BEAUTY_BIG_EYE = "Eye Size Warp Degree"; //大眼
    public final static String FX_BEAUTY_XIABA = "Chin Length Warp Degree"; //下巴
    public final static String FX_BEAUTY_NOSE = "Nose Width Warp Degree"; //鼻子
    public final static String FX_BEAUTY_SMALL_FACE = "Face Length Warp Degree";//小脸
    public final static String FX_BEAUTY_FACE_WIDTH = "Face Width Warp Degree";//窄脸
    public final static String FX_BEAUTY_HEAD = "Forehead Height Warp Degree";//额头
    public final static String FX_BEAUTY_NOSE_LENGTH  = "Nose Length Warp Degree";//长鼻
    public final static String FX_BEAUTY_EYE_CORNER = "Eye Corner Stretch Degree";// 眼角
    public final static String FX_BEAUTY_MOUTH_SIZE  = "Mouth Size Warp Degree";// 嘴形
    public final static String FX_BEAUTY_MOUTH_CORNER  = "Mouth Corner Lift Degree";// 嘴角
