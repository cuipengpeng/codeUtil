...
// */
//package com.meetvr.aicamera.phonealbum.adapter.hardwareadapter;
//
...
////import com.meetvr.aicamera.phonealbum.HardwareAlbumActivity;
...
////    private HardwareAlbumActivity fragment;
...
//
//    public AgendaSimpleSectionAdapter(List<List<MediaData>> agenda, List<MediaData> listOfOut, RecyclerView recyclerView,
//                                       OnTotalNumChange onTotalNumChange, int tag, Activity mActivity, int clickType, int limitCount, HardwareAlbumActivity fragment) {
...
//        String yearMonthDate = AiCameraApplication.mApplication.getResources().getString(R.string.yearMonthDate);
//        SimpleDateFormat format = new SimpleDateFormat(yearMonthDate);
//        String todayTime = format.format(new Date());
//        String today =  AiCameraApplication.mApplication.getResources().getString(R.string.today);
...
//        View view = inflater.inflate(R.layout.item_hardware_media, parent, false);
//        view.setTag("1");
//        return new AgendaItemViewHolder(view, clickType,fragment);
//    }
//
//    @Override
...
//        }else{  //进入大图
//
//            onClickPreviewInterface.onClickpreviewlistener(v,headListPosition,childListPosition);
//        }
//
//    }
//
...
//        return fragment.getTotalSize();// fragment.getTotalSize()
//    }
//
...
//
//
//    public boolean  isCheckFlag=false;//  false  进入大图   true 进行选择
//    public  void setIsCheckFlag(boolean  b){
//        isCheckFlag=b;
//    }
//
//
//    public  void  cancleAll_check(){
//        for(int i=0;i<listOfParent.size();i++){
//                MediaData  bean=listOfParent.get(i);
//                bean.setState(false);
//            }
//
//        for(int i=0;i<lists.size();i++){
//            List<MediaData> children=lists.get(i);
//            for(int j=0;j<children.size();j++){
//                MediaData  bean=children.get(j);
//                bean.setState(false);
//            }
//        }
//        selectList.clear();
...
//
//
//        private  OnClickPreviewInterface  onClickPreviewInterface;
//
//        public void setOnClickPreviewInterface(OnClickPreviewInterface  onClickPreviewInterface){
//          this.onClickPreviewInterface=onClickPreviewInterface;
//      }
//       public  interface   OnClickPreviewInterface{
//             void  onClickpreviewlistener(View v, int headListPosition, int childListPosition);
//       }
//
//}
