...
public class WheelHorizontalScroller {
     ...
     * Scrolling duration
     */
    public static final int SCROLLING_DURATION = 10;
    ...
    private static final int MAX_FLING_VELOCITY = 3000;
    ...
    private GestureDetector.SimpleOnGestureListener gestureListener = new GestureDetector.SimpleOnGestureListener() {
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            lastScrollX = 0;
            velocityX = (int) ((Math.min(Math.abs(velocityX), MAX_FLING_VELOCITY) ) * Math.signum(velocityX));
            scroller.fling(0, 0, (int) -velocityX, 0, -0x7FFFFFFF, 0x7FFFFFFF, 0, 0);
            setNextMessage(MESSAGE_SCROLL);
            return true;
        }
    };
    ...
    private Handler animationHandler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(Message msg) {
            ...
            // scrolling is not finished when it comes to final X
