...
import static com.test.xcamera.picasso.Picasso.TAG;
...
final class Utils {
    ...
    private static final int MIN_DISK_CACHE_SIZE = 50 * 1024 * 1024; // 500MB
    private static final int MAX_DISK_CACHE_SIZE = 500 * 1024 * 1024; // 500MB
