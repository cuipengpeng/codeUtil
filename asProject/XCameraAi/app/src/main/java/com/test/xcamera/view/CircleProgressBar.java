...
public class CircleProgressBar extends View {
    ...
    private void initFromAttributes(Context context, AttributeSet attrs) {
        ...
        mStyle = a.getInt(R.styleable.CircleProgressBar_style_type, LINE);
        ...
        mLineWidth = a.getDimensionPixelSize(R.styleable.CircleProgressBar_line_width, DensityUtils.dp2px(getContext(), DEFAULT_LINE_WIDTH));
        mProgressTextSize = a.getDimensionPixelSize(R.styleable.CircleProgressBar_progress_bar_text_size, DensityUtils.dp2px(getContext(), DEFAULT_PROGRESS_TEXT_SIZE));
        mProgressStrokeWidth = a.getDimensionPixelSize(R.styleable.CircleProgressBar_progress_stroke_width, DensityUtils.dp2px(getContext(), DEFAULT_PROGRESS_STROKE_WIDTH));
        ...
        mProgressTextColor = a.getColor(R.styleable.CircleProgressBar_progress_bar_text_color, Color.parseColor(COLOR_FFF2A670));
