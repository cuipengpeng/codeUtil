...
public class HeaderViewHolder extends RecyclerView.ViewHolder {
    ...
    public HeaderViewHolder(View itemView, @IdRes int titleID, int type, int limitMediaCount) {
        ...
        select_all = itemView.findViewById(R.id.meida_head_selectAll);
        clickType = type;
    ...
    public void render(String title, boolean state){
        ...
        if (clickType == MediaConstant.TYPE_ITEMCLICK_MULTIPLE){
            if(mLimitMediaCount >= 0)
                ...
                String checkAll = AiCameraApplication.mApplication.getResources().getString(R.string.checkAll);
                String cancleCheckAll = AiCameraApplication.mApplication.getResources().getString(R.string.cancelCheckAll);
