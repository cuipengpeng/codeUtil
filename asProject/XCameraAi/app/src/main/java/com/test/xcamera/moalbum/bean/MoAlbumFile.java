 ...
 */
public class MoAlbumFile implements Parcelable, Comparable<MoAlbumFile> {
    ...
    @Override
    public int compareTo(MoAlbumFile o) {
    ...
    public boolean equals(Object obj) {
        if (obj != null && obj instanceof MoAlbumFile) {
            MoAlbumFile o = (MoAlbumFile) obj;
    ...
    protected MoAlbumFile(Parcel in) {
    ...
    public static final Creator<MoAlbumFile> CREATOR = new Creator<MoAlbumFile>() {
        @Override
        public MoAlbumFile createFromParcel(Parcel source) {
            return new MoAlbumFile(source);
        }

        @Override
        public MoAlbumFile[] newArray(int size) {
            return new MoAlbumFile[size];
        }
    };
}