...
import static com.test.xcamera.picasso.Dispatcher.HUNTER_BATCH_COMPLETE;
import static com.test.xcamera.picasso.Dispatcher.REQUEST_BATCH_RESUME;
import static com.test.xcamera.picasso.Dispatcher.REQUEST_GCED;
import static com.test.xcamera.picasso.MemoryPolicy.shouldReadFromMemoryCache;
import static com.test.xcamera.picasso.Picasso.LoadedFrom.MEMORY;
import static com.test.xcamera.picasso.Utils.OWNER_MAIN;
import static com.test.xcamera.picasso.Utils.THREAD_LEAK_CLEANING_MS;
import static com.test.xcamera.picasso.Utils.THREAD_PREFIX;
import static com.test.xcamera.picasso.Utils.VERB_CANCELED;
import static com.test.xcamera.picasso.Utils.VERB_COMPLETED;
import static com.test.xcamera.picasso.Utils.VERB_ERRORED;
import static com.test.xcamera.picasso.Utils.VERB_RESUMED;
import static com.test.xcamera.picasso.Utils.checkMain;
import static com.test.xcamera.picasso.Utils.log;
...
public class Picasso {
    ...
    Picasso(Context context, Dispatcher dispatcher, Cache cache, Listener listener,
        ...
        //mo request
        allRequestHandlers.add(new MoCameraRequestHandler(stats));
     ...
     */
//    public static Picasso with() {不能删除
//        if (singleton == null) {
...
//    }
    ...
    public static Picasso with(Context context) {
        if (singleton == null) {
            synchronized (Picasso.class) {
                if (singleton == null) {
                    if (PicassoProvider.context == null && context == null) {
                        throw new IllegalStateException("context == null");
                    }
