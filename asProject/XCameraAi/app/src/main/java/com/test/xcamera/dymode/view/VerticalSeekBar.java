...
public class VerticalSeekBar extends AppCompatSeekBar {
    ...
    private SeekBarLocationCallback mLocationCallback;
    ...
    private void initialize(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (attrs != null) {
//            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.DyVerticalSeekBar, defStyleAttr, defStyleRes);
//            final int rotationAngle = a.getInteger(R.styleable.DyVerticalSeekBar_seekBarRotation, 0);
...
//            a.recycle();
        ...
        this.getThumb().setColorFilter(0XFFFFFFFF, PorterDuff.Mode.SRC_ATOP);
        this.getProgressDrawable().setColorFilter(0XFFFACD13, PorterDuff.Mode.SRC_ATOP);
        this.setMax(100);
    }

    public void setSeekBarLocationCallback(SeekBarLocationCallback callback) {
    ...
    private boolean onTouchEventUseViewRotation(MotionEvent event) {
        ...
        if (mLocationCallback != null) mLocationCallback.location(event.getX() - 90);
        if (handled) {
    ...
    public interface SeekBarLocationCallback {
