...
public class VerticalSeekBarWrapper extends FrameLayout {
    private static final String TAG = "VerticalSeekBarWrapper";

    private int mWidth, mHeight;
    private SeekBarSizeChangedListener mSizeChangedListener;
    ...
    public void setSeekBarSizeChangedListener(SeekBarSizeChangedListener listener) {
    ...
    public interface SeekBarSizeChangedListener {
