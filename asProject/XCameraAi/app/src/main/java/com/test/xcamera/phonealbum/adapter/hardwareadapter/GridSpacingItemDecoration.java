...
public class GridSpacingItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public GridSpacingItemDecoration(Context context, int spanCount) {
        ...
        marginSizeStart = (int) AiCameraApplication.mApplication.getResources().getDimension(R.dimen.select_item_start_end);
        marginSizeMiddle = (int) AiCameraApplication.mApplication.getResources().getDimension(R.dimen.select_item_between);
...
//        } else if (column == (spanCount - 1)) {  //最后一列
//            outRect.left = spaceBetweenItems - spanRightList.get(column - 1);
//            outRect.right = itemWidthInScreen - itemWidth - outRect.left;
//            spanRightList.add(outRect.right);
//        } else {
//            outRect.left = 20;//spaceBetweenItems - spanRightList.get(column - 1);
//            outRect.right = itemWidthInScreen - itemWidth - outRect.left;
//            spanRightList.add(outRect.right);
//        }
