...
//            }
//            statusView.setMessage(getResources().getString(R.string.ijk_play_error));
...
//    }
    ...
    public void onError() {
        ...
        playerContainer.removeView(statusView);
        if (statusView == null) {
            statusView = new StatusView(mCurrentUrl, getContext());
        }
        statusView.showErrorToast();
//        statusView.setMessage(getResources().getString(R.string.ijk_play_error));
//        statusView.setButtonTextAndAction(getResources().getString(R.string.replay), new OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                playerContainer.removeView(statusView);
//                addDisplay();
    ...
    public void setVideoController(@Nullable BaseVideoController mediaController) {
        ...
        if (mediaController != null) {
            ...
            LayoutParams params = new LayoutParams(
                    ...
                    FrameLayout.LayoutParams.MATCH_PARENT);
            playerContainer.addView(mVideoController, 0);
        }
    }
