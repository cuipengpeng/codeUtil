...
public class BreakpointDownloader {
	...
	public void download(String address, Handler handler){
	 ...
	 * @return
	 */
	public static void downloadSmallFile(final Handler handler, final int itemPosition, final String httpUrl, String fileName) {
