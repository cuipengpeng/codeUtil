...
import com.test.bank.adapter.PositionAllocationBondAdapter;
import com.test.bank.adapter.PositionAllocationStockAdapter;
...
//        pieData.setValueTextColor(Color.GREEN);
    ...
    private void getFundCompanyInfo() {
        ...
        HttpRequest.post(false, this, HttpRequest.APP_INTERFACE_WEB_URL + HttpRequest.POSITION_ALLOCATION, params, new HttpRequest.HttpResponseCallBack() {
            @Override
