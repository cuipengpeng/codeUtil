...
//                riskLevel="";
    ...
    private void getFundCompanyInfo() {
        ...
        HttpRequest.post( this, HttpRequest.APP_INTERFACE_WEB_URL + HttpRequest.BAOBAO_ASSERT_INFO, params, new HttpRequest.HttpResponseCallBank() {
            @Override
...
//        });
    ...
    private void getSevenDayYield() {
        ...
        HttpRequest.post(this, HttpRequest.APP_INTERFACE_WEB_URL + HttpRequest.SEVEN_DAY_YIELD_LIST, params, new HttpRequest.HttpResponseCallBank() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
