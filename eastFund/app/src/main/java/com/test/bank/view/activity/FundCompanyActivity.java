...
import com.test.bank.adapter.FundCompanyManageFundAdapter;
...
//        manageFundListRecyclerView.setHasFixedSize(true);
    ...
    private void getFundCompanyInfo(){
        ...
        HttpRequest.post(this, HttpRequest.APP_INTERFACE_WEB_URL +HttpRequest.FUND_COMPANY_INFO, params, new HttpRequest.HttpResponseCallBank() {
            @Override
