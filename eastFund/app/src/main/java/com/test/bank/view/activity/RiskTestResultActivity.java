...
public class RiskTestResultActivity extends BaseLocalDataActivity {
    ...
    private void getFundCompanyInfo() {
        ...
        HttpRequest.post(HttpRequest.APP_INTERFACE_WEB_URL_ENV_TEST + HttpRequest.RISK_TEST_QUESTIONS, params, this, new HttpRequest.HttpResponseCallBank() {
            @Override
...
//        }
        ...
        HttpRequest.post(HttpRequest.APP_INTERFACE_WEB_URL_ENV_TEST + HttpRequest.SUBMIT_RISK_TEST_ANSWERS, params, this, new HttpRequest.HttpResponseCallBank() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
