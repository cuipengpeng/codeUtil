...
public class RiskTestResultActivity extends BaseUILocalDataActivity {
    ...
    private void getFundCompanyInfo() {
        ...
        HttpRequest.post(false, this, HttpRequest.APP_INTERFACE_WEB_URL + HttpRequest.RISK_TEST_QUESTIONS, params, new HttpRequest.HttpResponseCallBack() {
            @Override
...
//        }
        ...
        HttpRequest.post(false, this, HttpRequest.APP_INTERFACE_WEB_URL + HttpRequest.SUBMIT_RISK_TEST_ANSWERS, params, new HttpRequest.HttpResponseCallBack() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
