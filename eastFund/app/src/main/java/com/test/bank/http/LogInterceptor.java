...
public class LogInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        LogUtils.d(TAG, String.format(Locale.getDefault(), "%s %s", method,
                headers.toString()));
        ...
        if (requestBody != null) {
            ...
            sb.append("]");
            LogUtils.d(TAG, String.format(Locale.getDefault(), "%s %s", method, java.net.URLDecoder.decode(sb.toString(), "utf-8")));
           }
