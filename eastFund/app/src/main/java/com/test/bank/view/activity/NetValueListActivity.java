...
import com.test.bank.adapter.NetValueListAdapter;
...
public class NetValueListActivity extends BaseUIActivity {
    ...
    private void getFundCompanyInfo(final boolean initRequest) {
        ...
        HttpRequest.post(HttpRequest.APP_INTERFACE_WEB_URL_ENV_TEST + HttpRequest.SINGLE_FUND_NET_VALUE, params, this, new HttpRequest.HttpResponseCallBank() {
            @Override
