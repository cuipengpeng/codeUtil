...
//                }
    ...
    private void getFundCompanyInfo() {
        ...
        HttpRequest.post(this, HttpRequest.APP_INTERFACE_WEB_URL + HttpRequest.PUT_IN_AND_GET_OUT_BANK_CARD_INFO, params, new HttpRequest.HttpResponseCallBank() {
            @Override
...
//        params.put("fundcode", fundCode);//基金代码（buytype为0时必须传入fundcode，为1时无需传入）
        ...
        HttpRequest.post( this, HttpRequest.APP_INTERFACE_WEB_URL + HttpRequest.CURRENT_PLUS_FUND_BUY, params, TAG, new HttpRequest.HttpResponseCallBank() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
