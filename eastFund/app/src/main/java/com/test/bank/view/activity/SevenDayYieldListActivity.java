...
public class SevenDayYieldListActivity extends BaseUIActivity {
    ...
    private void getSevenDayYield(final boolean initRequest) {
        ...
        HttpRequest.post(HttpRequest.APP_INTERFACE_WEB_URL_ENV_TEST + HttpRequest.BAOBAO_SEVEN_DAY_YIELD, params, this, new HttpRequest.HttpResponseCallBank() {
            @Override
    ...
    private void getWanfenIncome(final boolean initRequest) {
        ...
        HttpRequest.post(HttpRequest.APP_INTERFACE_WEB_URL_ENV_TEST + HttpRequest.BAOBAO_WAN_FEN_INCOME, params, this, new HttpRequest.HttpResponseCallBank() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
                WanfenIncomeBean wanfenIncomeBean = JSON.parseObject(response.body(), WanfenIncomeBean.class);
    ...
    private void getAccumulatedIncome(final boolean initRequest) {
        ...
        HttpRequest.post(HttpRequest.APP_INTERFACE_WEB_URL_ENV_TEST + HttpRequest.BAOBAO_ACCUMULATED_INCOME, params, this, new HttpRequest.HttpResponseCallBank() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
                WanfenIncomeBean wanfenIncomeBean = JSON.parseObject(response.body(), WanfenIncomeBean.class);
