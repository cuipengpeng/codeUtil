...
public class SevenDayYieldListActivity extends BaseUIActivity {
    ...
    private void getSevenDayYield(final boolean initRequest) {
        ...
        HttpRequest.post(false, this, HttpRequest.APP_INTERFACE_WEB_URL + HttpRequest.BAOBAO_SEVEN_DAY_YIELD, params, new HttpRequest.HttpResponseCallBack() {
            @Override
    ...
    private void getWanfenIncome(final boolean initRequest) {
        ...
        HttpRequest.post(false, this, HttpRequest.APP_INTERFACE_WEB_URL + HttpRequest.BAOBAO_WAN_FEN_INCOME, params, new HttpRequest.HttpResponseCallBack() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
                WanfenIncomeBean wanfenIncomeBean = JSON.parseObject(response.body(), WanfenIncomeBean.class);
    ...
    private void getAccumulatedIncome(final boolean initRequest) {
        ...
        HttpRequest.post(false, this, HttpRequest.APP_INTERFACE_WEB_URL + HttpRequest.BAOBAO_ACCUMULATED_INCOME, params, new HttpRequest.HttpResponseCallBack() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
                WanfenIncomeBean wanfenIncomeBean = JSON.parseObject(response.body(), WanfenIncomeBean.class);
