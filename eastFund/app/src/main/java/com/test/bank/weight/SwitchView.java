...
public class SwitchView extends View {
    ...
    public SwitchView(Context context, AttributeSet attrs) {
        ...
        final int DEFAULT_COLOR_PRIMARY = 0xFFF35857;
        final int DEFAULT_COLOR_PRIMARY_DARK = 0xFFDC5251;
        ...
        colorOff = a.getColor(R.styleable.SwitchView_offColor, 0xFFE3E3E3); //关闭状态按钮颜色
        colorOffDark = a.getColor(R.styleable.SwitchView_offColorDark, 0xFFBFBFBF); //关闭状态背景颜色
        colorShadow = a.getColor(R.styleable.SwitchView_shadowColor, 0xFF333333);   //阴影颜色
