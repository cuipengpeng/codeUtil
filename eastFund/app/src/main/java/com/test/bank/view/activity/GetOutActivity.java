...
//        params.put("fundcode", baobaoAssertInfoBean.getFundCode());//基金代码（buytype为0时必须传入fundcode，为1时无需传入）
        ...
        HttpRequest.post(HttpRequest.APP_INTERFACE_WEB_URL_ENV_TEST + HttpRequest.CURRENT_PLUS_FUND_REDEMPTION, params, this, TAG, new HttpRequest.HttpResponseCallBank() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
