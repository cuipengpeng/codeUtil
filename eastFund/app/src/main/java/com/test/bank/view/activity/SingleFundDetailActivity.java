...
//                dialog.setContentView(view);
    ...
    private void getFundDetailInfo() {
        ...
        HttpRequest.post(this, HttpRequest.APP_INTERFACE_WEB_URL + HttpRequest.SINGLE_FUND_DETAIL, params, new HttpRequest.HttpResponseCallBank() {
            @Override
...
//                    fundTypeTag2TextView.setBackgroundResource(R.drawable.rectangle_gray_border_gray_bg);
    ...
    private void getFundArchivesWithAnnouncement() {
        ...
        HttpRequest.post(this, HttpRequest.APP_INTERFACE_WEB_URL + HttpRequest.FUND_ARCHIVES_WITH_ANNOUNCEMENT, params, new HttpRequest.HttpResponseCallBank() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
    ...
    private void getSingleFundYieldTrend() {
        ...
        HttpRequest.post(this, HttpRequest.APP_INTERFACE_WEB_URL + HttpRequest.SINGLE_FUND_YIELD_TREND, params, new HttpRequest.HttpResponseCallBank() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
...
//        params.put("fundcode", fundCode);
        ...
        HttpRequest.post(this, HttpRequest.APP_INTERFACE_WEB_URL + HttpRequest.ADD_TO_OPTIONAL_FUND, params,  new HttpRequest.HttpResponseCallBank() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
                baseRightMenuImageView.setBackgroundResource(R.mipmap.optional_selected);
...
//        params.put("fundcode", fundCode);
        ...
        HttpRequest.post(this, HttpRequest.APP_INTERFACE_WEB_URL + HttpRequest.DELETE_OPTIONAL_FUND, params, new HttpRequest.HttpResponseCallBank() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
                baseRightMenuImageView.setBackgroundResource(R.mipmap.add_optional);
