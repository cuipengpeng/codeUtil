	...
	public void onClick(View v) {
		...
		if (v == zero) {
			...
			CommonUtils.startWebViewActivity(mContext,
					MyAccountFragment.getOneCardUrlParamter(mContext, HttpRequest.ONE_CARD_WEB_URL+HttpRequest.H5_ONE_CARD_PAGE_SUB_URL+HttpRequest.H5_ONE_CARD_PAGE_FORGET_TRATE_PASSWORD),
					true, false, false);
