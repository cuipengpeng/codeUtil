...
public class HttpRequest {
    ...
    //品质web服务器      测试环境
    public static final String QUALITY_MARKET_TEST_ENV_WEB_URL = "https://sctest.9fbank.com/";//http://101.200.87.124/";
    //预发环境
    public static final String QUALITY_MARKET_PRE_ENV_WEB_URL = "https://123.56.167.11:8102/app/";
    // 正式环境
    public static final String QUALITY_MARKET_ONLINE_ENV_WEB_URL = "https://sc.9fbank.com/";

    //万卡web服务器      测试环境
    public static final String ONE_CARD_TEST_ENV_WEB_URL = "https://wxtest.9fbank.com/";
    //预发环境
    public static final String ONE_CARD_PRE_ENV_WEB_URL = ONE_CARD_TEST_ENV_WEB_URL;
    // 正式环境
    public static final String ONE_CARD_ONLINE_ENV_WEB_URL = "https://wx.9fbank.com/";
    ////万卡API地址 --测试环境
    public static final String ONE_CARD_APITEST_ENV_WEB_URL = "https://wxapitest.9fbank.com/";
    //万卡API地址 --预发环境
    public static final String ONE_CARD_API_PRE_ENV_WEB_URL = ONE_CARD_APITEST_ENV_WEB_URL;
    ////万卡API地址 --正式环境
    public static final String ONE_CARD_API_ONLINE_ENV_WEB_URL = "https://wxapi.9fbank.com/";
    ...
    public static final String H5_PAGE_SUB_URL = "qualitymarkets/";
    public static final String H5_ONE_CARD_PAGE_SUB_URL = "h5/";


    public static String QUALITY_MARKET_WEB_URL = QUALITY_MARKET_TEST_ENV_WEB_URL;
    public static String ONE_CARD_WEB_URL = ONE_CARD_TEST_ENV_WEB_URL;
    public static String ONE_CARD_API_URL = ONE_CARD_TEST_ENV_WEB_URL;
    ...
    public static void initEnvironment() {
        if (currentEnv == Environment.TEST) {
            ...
            ONE_CARD_WEB_URL = ONE_CARD_TEST_ENV_WEB_URL;
            FACE_DETECT_WEB_URL = FACE_DETECT_TEST_ENV_URL;
            ONE_CARD_API_URL = ONE_CARD_APITEST_ENV_WEB_URL;
            ...
            ONE_CARD_WEB_URL = ONE_CARD_PRE_ENV_WEB_URL;
            FACE_DETECT_WEB_URL = FACE_DETECT_PRE_ENV_URL;
            ONE_CARD_API_URL = ONE_CARD_API_PRE_ENV_WEB_URL;
            ...
            ONE_CARD_WEB_URL = ONE_CARD_ONLINE_ENV_WEB_URL;
            ONE_CARD_API_URL = ONE_CARD_API_ONLINE_ENV_WEB_URL;
    ...
    public static Call<String> post(Context context, String url, Map<String, String> params, AsyncResponseCallBack responseHandler) {
        return post(context, 20, 20, 20, url, params, responseHandler);
    }
    ...
    public static Call<String> post(Context context, long readTime, long writeTime, long timeOut, String url, Map<String, String> params, AsyncResponseCallBack responseHandler) {
        //TODO  网络统一接口添加requestChannel参数，用于特殊处理
